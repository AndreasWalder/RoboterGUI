...
namespace GRBL_Plotter
{
    public partial class MainForm
    {
        ...
        Style StylePWord = new TextStyle(Brushes.DarkRed, null, FontStyle.Regular);
        ...
        Style StyleXAxis = new TextStyle(Brushes.Navy, null, FontStyle.Bold);
        Style StyleYAxis = new TextStyle(Brushes.Orange, null, FontStyle.Bold);
        Style StyleZAxis = new TextStyle(Brushes.Olive, null, FontStyle.Bold);
        Style StyleEAxis = new TextStyle(Brushes.BlueViolet, null, FontStyle.Bold);
        Style StyleAAxis = new TextStyle(Brushes.Green, null, FontStyle.Bold);
        Style StyleBAxis = new TextStyle(Brushes.Violet, null, FontStyle.Bold);
        Style StyleCAxis = new TextStyle(Brushes.Blue, null, FontStyle.Bold);
        ...
        private void fCTBCode_TextChanged(object sender, FastColoredTextBoxNS.TextChangedEventArgs e)
        {
            ...
            e.ChangedRange.SetStyle(StylePWord, "(P\\d+)", System.Text.RegularExpressions.RegexOptions.Compiled);
            ...
            e.ChangedRange.SetStyle(StyleEAxis, "[Ee]{1}-?\\d+(.\\d+)?", System.Text.RegularExpressions.RegexOptions.Compiled);
            e.ChangedRange.SetStyle(StyleAAxis, "[Aa]{1}-?\\d+(.\\d+)?", System.Text.RegularExpressions.RegexOptions.Compiled);
            e.ChangedRange.SetStyle(StyleBAxis, "[Bb]{1}-?\\d+(.\\d+)?", System.Text.RegularExpressions.RegexOptions.Compiled);
            e.ChangedRange.SetStyle(StyleCAxis, "[Cc]{1}-?\\d+(.\\d+)?", System.Text.RegularExpressions.RegexOptions.Compiled);
        }
     ...
     //               MessageBox.Show("textchangedelayed");
        ...
        {
        //string curLine;
        //    string allowed = "ABCENGMFIJKLNPRSTUVWXYZOPLngmfijklnprstuvwxyzopl ";
