            ...
            if (Map != null)
            {
                ...
                if (result == System.Windows.Forms.DialogResult.Yes)
                {
                    if ((decimal)actualPosWorld.Z < nUDProbeUp.Value)
                        OnRaiseXYZEvent(new XYZEventArgs(null, null, (double)nUDProbeUp.Value, "G1"));
                    OnRaiseXYZEvent(new XYZEventArgs(posX, posY, "G1 G0"));   // move relative and fast
                }
            }
        }
